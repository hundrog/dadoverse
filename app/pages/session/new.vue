        ...
        <template #create>
          <div class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-2">
              <p class="text-sm font-medium uppercase text-muted">Review</p>
              <div class="flex flex-col gap-1">
                ...
                <div class="flex justify-between">
                  <span class="text-sm text-muted">System</span>
            ...
            <div class="flex flex-col gap-4">
              <p class="text-sm font-medium uppercase text-muted">
                Configuration
              </p>
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-xs text-muted">Let others join as observers</p>
                </div>
              ...
              <div class="flex items-center justify-between">
                <div>
                  ...
                  <p class="text-xs text-muted">Visual style for the session</p>
                </div>
                <USelect
